...
from sqlalchemy.orm import sessionmaker, Session # Ensure Session is imported for type hints
...
# CRITICAL: Import Base from the dedicated file
from app.core.base_model import Base 
# -------------------------------------------------------------------------------------------------------
# UPDATED IMPORTS: Including all necessary ORM models for seeding
# -------------------------------------------------------------------------------------------------------
...
SQLALCHEMY_DATABASE_URL = "postgresql://postgres:Safapac2025@safapac-instance-dev-only.coh4oqko8ir5.us-east-1.rds.amazonaws.com:5432/safapac_db"
...
# --- UNIT MASTER DATA DEFINITIONS (Kept as is for unit seeding) ---
UNIT_GROUPS = [
...
def create_tables():
    """Creates tables only, ensuring explicit transaction for DDL."""
    
    # CRITICAL: Import the models module here to register all ORM classes with Base.metadata.
    import app.models.biofuel_model

    logger.info("Attempting to create database tables with explicit transaction...")
